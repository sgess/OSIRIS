...
if param_struct.hollow.use == 0
    ...
    os_struct.profile(2).nx = num2str(6);
    % plasma N z
    os_struct.profile(2).fx1 = [num2str(0.0) sep num2str(0.0) sep num2str(1.0)...
        sep num2str(1.0) sep num2str(1.0) sep num2str(1.0) eol];
    % plasma Z z
    os_struct.profile(2).x1 = [num2str(0.0,'%0.0f') sep num2str(param_struct.pos.plasma_Z_start,'%0.0f')...
        sep num2str(param_struct.pos.plasma_Z_ramp,'%0.0f') sep num2str(param_struct.pos.plasma_Z_end/2,'%0.0f')...
        sep num2str(3*param_struct.pos.plasma_Z_end/4,'%0.0f') sep num2str(param_struct.pos.plasma_Z_end,'%0.0f') eol];
    % plasma N r
    ...
    elseif strcmp(param_struct.hollow.type,'gauss')
        os_struct.profile(2).num_x = [num2str(param_struct.hollow.n_points) eol];
        os_struct.profile(2).nx = num2str(param_struct.hollow.n_points);
    ...
    elseif strcmp(param_struct.hollow.type,'trap')
        os_struct.profile(2).num_x = [num2str(param_struct.hollow.n_points) eol];
        os_struct.profile(2).nx = num2str(param_struct.hollow.n_points);
        ...
        % N r string
        n_r_start = num2str(param_struct.hollow.N_vec(1),'%0.0f');
        n_r_mid = [];
        for i = 2:param_struct.hollow.n_points; n_r_mid = [n_r_mid sep num2str(param_struct.hollow.N_vec(i),'%0.0f')]; end;
        n_r_end = eol;
        os_struct.profile(2).fx2 = [n_r_start n_r_mid n_r_end];
    ...
    elseif strcmp(param_struct.hollow.type,'partial')
        os_struct.profile(2).num_x = [num2str(param_struct.hollow.n_points) eol];
        os_struct.profile(2).nx = num2str(param_struct.hollow.n_points);
        ...
        % N r string
        n_r_start = num2str(param_struct.hollow.N_vec(1),'%0.3f');
        n_r_mid = [];
        for i = 2:param_struct.hollow.n_points; n_r_mid = [n_r_mid sep num2str(param_struct.hollow.N_vec(i),'%0.3f')]; end;
        n_r_end = eol;
        os_struct.profile(2).fx2 = [n_r_start n_r_mid n_r_end];
    ...
    elseif strcmp(param_struct.hollow.type,'uniform')
        os_struct.profile(2).num_x = [num2str(param_struct.hollow.n_points) eol];
        os_struct.profile(2).nx = num2str(param_struct.hollow.n_points);
    ...
    elseif strcmp(param_struct.hollow.type,'hollowPart')
        os_struct.profile(2).num_x = [num2str(param_struct.hollow.n_points) eol];
        os_struct.profile(2).nx = num2str(param_struct.hollow.n_points);
