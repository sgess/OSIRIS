...
#
  ...
  echo "    \$qqscratch"
  echo "  osiris-2D.e 8-way parallel job configuration:"
  echo "    \$qqconfig" | tr "\\\\" "\n"
#
  echo ""
...
#
  ...
  echo \$MPI_BIN/mpiexec \$btl_command -n 8 "" /u/d2scratch/$me/$dirname/osiris-2D.e \>\& osiris-2D.e.output.\$JOB_ID
  echo ""

#  time \$MPI_BIN/mpiexec  -n 8 -machinefile \$QQ_NODEFILE  \\
  time \$MPI_BIN/mpiexec \$btl_command -n 8 -machinefile \$QQ_NODEFILE  \\
...
qsub -l express osiris-2D.e.cmd
