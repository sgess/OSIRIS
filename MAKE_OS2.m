...
input_struct.hollow.radius     = 77.6;              % central radius in microns
...
input_struct.beam.N_particles  = 1.00e10;          % Number of beam particles
input_struct.beam.gamma        = 40000;           % relativistic factor gamma, if 0 energy specified below
input_struct.beam.sigma_r      = 10.;             % Gaussian sigma_x [um]
input_struct.beam.sigma_z      = 20.0;            % Gaussian sigma_z [um]
input_struct.beam.emit_r       = 10.0;            % normalized X emittance [mm*mrad i.e. 1e-6]
...
input_struct.pos.Center_Z        = 28;            % beam centroid position in
input_struct.pos.Range_R_max     = 2.5;           % Max extent of beam in R
input_struct.pos.Range_R_min     = 0;             % Min extent of beam in R
input_struct.pos.Range_Z_max     = 31.8;          % Max extent of beam in Z
input_struct.pos.Range_Z_min     = 24.2;          % Min extent of beam in Z
